...
# shrake_img = Label(frame2, image=img1, bg="grey40").place(x=305, y=109)
...
# check_btn = Checkbutton(frame2, text="Keep me logged in.", highlightbackground="red", highlightcolor="red", bg="grey40", fg="white").place(x=60, y=70)
